...
file = np.load('D:/npz/Figure7_obs_Ross_1025.npz')
...
# plt.savefig('C:/Users/fzjxw/python/code/Figures/Figure7_obs.png' ,dpi=300,bbox_inches='tight')
plt.show()

#合在一起出图
# plt.close()
# fig = plt.figure(1, figsize=(150/25.4,8))
...
#region 模式
# date = ['Sep','Oct','Nov','Dec','Jan','Feb','Mar','Apr']
file_mdl = np.load('D:/npz/Figure7_model_Ross_1025.npz')
...
# plt.savefig('C:/Users/fzjxw/python/code/Figures/Figure7_model.png' ,dpi=300,bbox_inches='tight')
plt.show()
#endregion
...
# lines = ax3.get_lines()+ax4.get_lines()
# plt.legend(lines, [l.get_label() for l in lines],edgecolor='k',loc='lower right')
# plt.savefig('/stu02/weizx24/figures/0924/Figure7_all.png' ,dpi=300,bbox_inches='tight')
# #endregion
