...
ax1.text(0, 1.05, '(d)', transform=ax1.transAxes, va='top', ha='right')
...
m.drawmeridians([90,120,150,180,210,240,270,300,330], linewidth=1.2,labels=[False,False,False,True],fmt='%g',latmax=80)
m.drawparallels([-60,-70,-80], linewidth=1.2,labels=[False,False,False,False],latmax=80,)
# ax.annotate(r'$70\degree\,\mathrm{S}$',xy=m(190,-70),xycoords='data')
# ax.annotate(r'$80\degree\,\mathrm{S}$',xy=m(190,-80),xycoords='data')
m.drawcoastlines(color='blue')
m.fillcontinents(color='gray')
...
# cb.set_label(f'Sea ice advection'+r'(% km day$^{\text{-1}}$)', fontsize=23,)
# cb.ax.text(0.5, -3, r'Sea ice advection (% km day$^{-1}$)', 
#            fontsize=23, ha='center', va='center', transform=cb.ax.transAxes)
fig.text(0.5, 0, r'Sea ice advection (% km day$^{-1}$)', 
         ha='center', va='center', fontsize=23)
    
# ax.text(0,0,f'Sea ice advection'+r'(% km day$^{\text{-1}}$)', fontsize=23,)
ax.text(0, 1.05, '(h)', transform=ax.transAxes, va='top', ha='right')
