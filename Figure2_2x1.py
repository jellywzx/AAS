...
plt.legend(bbox_to_anchor=(0,1),edgecolor='k',loc='upper left',ncol=4,fontsize=14)
ax1.text(0, 1.05, '(a)', fontsize=22, transform=ax1.transAxes, va='top', ha='right')
...
plt.xticks(date_num[::9],date_list[::9])
# plt.yticks(fontsize=20)
ax2.set_ylabel('Areas'+ r' (10$^{6}$ km$^{2}$)')
ax2.set_xlabel('Date')
ax2.grid(axis='y',alpha=0.5)
plt.setp(bp['boxes'][27:34],color='red')
ax2.text(0, 1.08, '(b)', fontsize=22,transform=ax2.transAxes, va='top', ha='right')
#endregion
...
ax3.scatter(df['years'],df['data'],color=df['color'],s=50)
...
legend_elements = [Line2D([0], [0], marker='o', color='r', label='Large',
                    ...
                    Line2D([0], [0], marker='o', color='b', label='Small',
                          markerfacecolor='b'),]
ax3.legend(handles=legend_elements, loc='upper right',bbox_to_anchor=(0.95, 1.0),fontsize=15)
...
props = dict(boxstyle='round', facecolor='wheat', alpha=0.5)
ax3.text(0, 1.08, '(c)', fontsize=22,transform=ax3.transAxes, va='top', ha='right')
