...
sic_Feb = xr.open_dataset('D:/land01/siconc_SImon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_Feb.nc')['siconc']
...
# ross_mask =  (lats<-70.)&(lons>160.)&(lons<230.)
...
np.savez('D:/npz/Figure7_obs_Ross_1025.npz',ross_lhf_dif=ross_lhf_dif,ross_lw_dif=ross_lw_dif,ross_shf_dif=ross_shf_dif,ross_sw_dif=ross_sw_dif,ross_Qnet_dif=ross_Qnet_dif,ross_votemp_dif=ross_votemp_dif)
print('观测数据处理完毕')
#endregion
...
hfls = xr.open_dataset('D:/CMIP6/CESM2-WACCM-FV2/piControl/Amon/hfls/hfls_Amon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_all.nc')['hfls']
# surface_upward_sensible_heat_flux
hfss = xr.open_dataset('D:/CMIP6/CESM2-WACCM-FV2/piControl/Amon/hfss/hfss_Amon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_all.nc')['hfss']
# Surface Downwelling Longwave Radiation
rlds = xr.open_dataset('D:/CMIP6/CESM2-WACCM-FV2/piControl/Amon/rlds/rlds_Amon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_all.nc')['rlds']
# Surface Upwelling Longwave Radiation
rlus = xr.open_dataset('D:/CMIP6/CESM2-WACCM-FV2/piControl/Amon/rlus/rlus_Amon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_all.nc')['rlus']
# Surface Downwelling Shortwave Radiation
rsds = xr.open_dataset('D:/CMIP6/CESM2-WACCM-FV2/piControl/Amon/rsds/rsds_Amon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_all.nc')['rsds']
# Surface Upwelling Shortwave Radiation
rsus = xr.open_dataset('D:/CMIP6/CESM2-WACCM-FV2/piControl/Amon/rsus/rsus_Amon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_all.nc')['rsus']
...
thetao = xr.open_dataset('D:/CMIP6/CESM2-WACCM-FV2/piControl/Omon/thetao/thetao_Omon_CESM2-WACCM-FV2_piControl_r1i1p1f1_gn_000101-049912_all.nc')['thetao'].sel(lev=slice(0,5000)).mean('lev')
year_min = sic_Feb.time[ross_sie_cmip6<Q1].dt.year
year_max = sic_Feb.time[ross_sie_cmip6>Q3].dt.year
...
np.savez('D:/npz/Figure7_model_Ross_1025.npz',ross_sw_dif=ross_sw_dif,ross_lw_dif=ross_lw_dif,ross_hfls_dif=ross_hfls_dif,ross_hfss_dif=ross_hfss_dif,ross_Qnet_dif=ross_Qnet_dif,ross_thetao_dif=ross_thetao_dif)
print('观测数据处理完毕')
#endregion