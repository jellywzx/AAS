...
Q1 = m.quiver(xx,yy,uproj*-1,vproj*-1,scale=15,color='purple',scale_units='inches', width=0.005)
# qk1 = plt.quiverkey(Q1, 0.16, -0.05, 5, '5 km/day', labelpos='W')
cs = m.contourf(x1,y1, 1-pval3, levels=[0.95, 1] ,colors='none',hatches=['.', None],alpha=0)
m.drawmeridians([90,120,150,180,210,240,270,300,330], labels=[False,False,False,False],fmt='%g',latmax=80,)
...
im = m.contourf(x,y,sic_dif,
                ...
                extend='both',
                shading='faceted', antialiased=True,cmap=cmaps.BlueWhiteOrangeRed)
q1 = m.quiver(xs[::5,::5],ys[::5,::5],us_wdir[::5,::5]*-1,vs_wdir[::5,::5]*-1,scale=15, color='purple',scale_units='inches', width=0.005)
qk1 = plt.quiverkey(q1, 0.88, 0.6, 5, '5 km/day', labelpos='W',color='purple',)
...
cb.set_label("SIC (%)",fontsize=23.5)
