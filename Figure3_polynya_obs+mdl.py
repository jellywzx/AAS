...
fig = plt.figure(figsize=(160/25.4,9))
...
figname = '(d) Climatology'
ax4.set_title(figname)
m = Basemap(projection='stere',resolution='c',
            lat_0=-90, lon_0=0,  lat_ts=(-90.+-55.)/2.,
            llcrnrlon=-135,urcrnrlon=20,llcrnrlat=-50,urcrnrlat=-72)
x1,y1 = m(lons,lats)
im1 = m.contourf(x1,y1,sic_clm,
                    ...
                    shading='faceted', antialiased=True,cmap='Blues')
# im2 = m.contourf(x1,y1,sic_sel,levels=[0.15,1],hatches=['///', None],alpha=0)
m.contour(x1,y1,sic_clm,levels=[15],colors='green')
# xpt1,ypt1 = m(218,-67)
# ax4.text(xpt1,ypt1,'Eastern Ross ',color='white')
# xpt2,ypt2 = m(182,-68)
# ax4.text(xpt2,ypt2,'Western \n Ross ',color='white')
# xpt3,ypt3 = m(250,-63)
...
m.drawcoastlines(color='black')
m.fillcontinents(color='gray')
m.drawmeridians([90,120,150,180,230,270,300,330], linewidth=1.2,labels=[True,False,False,True],fmt='%g',latmax=80)
m.drawparallels([-60,-70,-80], linewidth=1.2,labels=[False,False,False,True],latmax=80)
...
im1 = m.contourf(x1,y1,sic_max,
                    ...
                    shading='faceted', antialiased=True,cmap='Blues')
# im2 = m.contourf(x1,y1,sic_sel,levels=[0.15,1],hatches=['///', None],alpha=0)
m.contour(x1,y1,sic_max,levels=[15],colors='green')
# xpt1,ypt1 = m(218,-67)
# ax5.text(xpt1,ypt1,'Eastern Ross ',color='white')
# xpt2,ypt2 = m(182,-68)
# ax5.text(xpt2,ypt2,'Western \n Ross ',color='white')
# xpt3,ypt3 = m(250,-63)
# ax.text(xpt3,ypt3,'Amundsen',fontsize=20)
# xpt4,ypt4 = m(273,-61.5)
# ax.text(xpt4,ypt4,'Bellingshausen ',fontsize=20)
...
im1 = m.contourf(x1,y1,sic_min,
                    ...
                    shading='faceted', antialiased=True,cmap='Blues')
# im2 = m.contourf(x1,y1,sic_sel,levels=[0.15,1],hatches=['///', None],alpha=0)
m.contour(x1,y1,sic_min,levels=[15],colors='green')
# xpt1,ypt1 = m(218,-67)
# ax6.text(xpt1,ypt1,'Eastern Ross ',color='white',)
# xpt2,ypt2 = m(182,-68)
# ax6.text(xpt2,ypt2,'Western \n Ross ',color='white')
# xpt3,ypt3 = m(250,-63)
# ax.text(xpt3,ypt3,'Amundsen',fontsize=20)
# xpt4,ypt4 = m(273,-61.5)
# ax.text(xpt4,ypt4,'Bellingshausen ',fontsize=20)
...
cax = fig.add_axes([0.1, 0.32, 0.8, 0.1],aspect=0.02)
...
#axs[2, 1].axis('off')
#axs[2, 2].axis('off')
ax7.plot(date_list[:-5],a_max[:-5],color='r',label='Large ')
ax7.plot(date_list[:-5],a_clm[:-5],color='k',label='Climatology ')
ax7.plot(date_list[:-5],a_min[:-5],color='b',label='Small ')
ax7.set_xlabel('Date')
ax7.set_ylabel('Areas'+ r' (10$^{6}$ km$^{2}$)',)
ax7.set_xticks(date_list[:-5][::5])
ax7.set_yticks([0,0.2,0.4,0.6])
ax7.grid(color='lightgray',linestyle='--',alpha=0.4)
ax7.legend(edgecolor='k',loc='upper left')
ax7.text(0, -0.3, '(g)', fontsize=10, transform=ax4.transAxes, va='top', ha='right')
